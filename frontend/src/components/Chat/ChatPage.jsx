...
const ChatPage = () => {
    return (
        <div className="relative flex items-center justify-center h-screen bg-gradient-to-br from-pink-400 to-indigo-700 overflow-hidden">
            ...
            <div className="flex w-full max-w-4xl h-4/5 bg-white shadow-2xl rounded-lg overflow-hidden">
                <Sidebar />
                <MessageContainer />
            </div>
        </div>
